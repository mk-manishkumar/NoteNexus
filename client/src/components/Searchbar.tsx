...
export const Searchbar: React.FC<SearchbarProps> = ({ searchTerm, setSearchTerm }) => {
  ...
  return (
    <div className="mt-8 px-5">
      <form onSubmit={handleSubmit} className="flex items-center max-w-md mx-auto relative group">
        {/* Background effect */}
        ...
        <input
          ...
          className={`relative z-10 w-full px-6 py-3 h-12 text-white placeholder-gray-300 outline-none 
        ...
        <Button
          type="submit"
          aria-label="Search"
          className="relative z-10 bg-gradient-to-r from-blue-600 to-purple-600 
